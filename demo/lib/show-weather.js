...
$(document).ready(function () {
  var location = "成都";
  var uri = encodeURIComponent(location);
  var btn = $("#ajax");
  //weather.json is for test
  $.ajax({
    type: "GET",
    //  url: "weather.json",
    url: "http://v.juhe.cn/weather/index?format=2" + "&cityname=" + uri + "&key=" + "0f020205d64b8e54776a1bed6aa3d741",
    dataType: "json",
  ...
  $.ajax({
    type: "GET",
    url: "http://web.juhe.cn:8080/environment/air/pm?" + "city=" + location + "&key=" + "dd536747a8de2f295d022958e0cddd4d",
    dataType: "json",
    success: function success(data) {
      handleAirDatas(data);
    },
